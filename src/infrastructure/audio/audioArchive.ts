...
export class AudioArchiveService {
  ...
  private async initializeDB(): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        logger.error('AudioArchive', 'Failed to initialize audio database', request.error || undefined);
        reject(request.error || new Error('Failed to initialize audio database'));
      };
  ...
  async storeRecording(
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        logger.error('AudioArchive', 'Failed to store audio recording', request.error || undefined);
        reject(request.error || new Error('Failed to store audio recording'));
      };
    });
  }
  ...
  async getRecording(recordingId: string): Promise<AudioArchiveEntry | null> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        logger.error('AudioArchive', 'Failed to retrieve audio recording', request.error || undefined);
        reject(request.error || new Error('Failed to retrieve audio recording'));
      };
    });
  }
  ...
  async getRecordingsForEncounter(encounterId: string): Promise<AudioArchiveEntry[]> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        logger.error('AudioArchive', 'Failed to retrieve encounter recordings', request.error || undefined);
        reject(request.error || new Error('Failed to retrieve encounter recordings'));
      };
    });
  }
  ...
  async getArchiveMetrics(): Promise<AudioMetrics> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        logger.error('AudioArchive', 'Failed to retrieve archive metrics', request.error || undefined);
        reject(request.error || new Error('Failed to retrieve archive metrics'));
      };
    });
  }
  ...
  async updateRecordingMetadata(
    ...
    return new Promise((resolve, reject) => {
      ...
      getRequest.onsuccess = () => {
        ...
        putRequest.onerror = () => {
          logger.error('AudioArchive', 'Failed to update recording metadata', putRequest.error || undefined);
          reject(putRequest.error || new Error('Failed to update recording metadata'));
        };
      };

      getRequest.onerror = () => {
        logger.error('AudioArchive', 'Failed to retrieve recording for update', getRequest.error || undefined);
        reject(getRequest.error || new Error('Failed to retrieve recording for update'));
      };
    });
  }
  ...
  async cleanupOldRecordings(retentionDays: number = 90): Promise<number> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        logger.error('AudioArchive', 'Failed to cleanup old recordings', request.error || undefined);
        reject(request.error || new Error('Failed to cleanup old recordings'));
      };
    });
  }
  ...
  private async getAllRecordings(): Promise<AudioArchiveEntry[]> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        reject(request.error || new Error('Failed to get all recordings'));
      };
    });
  }
}
