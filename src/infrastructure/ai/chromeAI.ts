 ...
 * 
 * NOTE: Chrome AI APIs (Prompt, Summarizer, Translator) are NOT available in Web Workers
 * according to official Chrome documentation. All AI processing runs on the main thread
 * using mainThreadAI.ts with async yielding to prevent UI blocking.
 * 
 * @module infrastructure/ai/chromeAI
 */
